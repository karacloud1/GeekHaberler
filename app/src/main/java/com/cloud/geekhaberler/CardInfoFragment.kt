...
import com.cloud.geekhaberler.databinding.FragmentCardInfoBinding
...
class CardInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_card_info,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Picasso.get().load(image).resize(800,0).into(binding.imageView)
    }
    companion object {
        @JvmStatic
